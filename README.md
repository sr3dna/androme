        ...
        <android.support.v7.widget.GridLayout
            ...
            <RelativeLayout
                ...
                <TextView
                    ...
                    android:layout_width="wrap_content"
                    android:text="@string/__symbol2043"
                    style="@style/Plaintext" />
            </RelativeLayout>
            <RelativeLayout
            ...
            <Spinner
                ...
                android:background="@drawable/select_series_1"
...
<resources>
    ...
    <string name="__symbol2043">):</string>
...
<resources>
    ...
    <style name="Select.Linearlayout_1">
        <item name="android:background">@drawable/select_series_1</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:layout_width">wrap_content</item>
...
<resources>
    ...
    <dimen name="radio_margin_start_1">6dp</dimen>
    ...
    <dimen name="select_width">200dp</dimen>
    <dimen name="select_width_1">160dp</dimen>
...
<!-- filename: res/drawable/select_series_1.xml -->
